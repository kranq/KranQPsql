...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'city_code' => [
            'required' => 'City Code field is required',
        ],
        'city_id' => [
            'required' => 'Select City Name is required',
        ],
        'locality_name' => [
            'required' => 'Locality Name field is required',
        ],
        'category_name' => [
        ...
        'order_by' => [
            'required' => 'Select Order By field is required',
        ],
        'fullname' => [
