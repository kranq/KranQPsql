<html>
<head>
<link rel="stylesheet" href="../../../1.0.0/public/css/bootstrap.css" />
</head>
<body>
<div class="container">
  <div style="border:solid 1px #999999; position: relative;    left: 14.4em; width: 60% !important; border:1px solid #000; background-color:#fff; border-collapse:collapse;" align="center">
    <div style="background: #1fb5ad none repeat scroll 0 0; min-height:70px;"> <img  src="../../../1.0.0/public/images/logocrop.png"  style="width: 170px; " alt="KranQ" title="KranQ"></div>
    <section class="panel">
