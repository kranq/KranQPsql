            ...
            if ($data) {
                ...
                if ($data['email'] && $data['password'] && $data['category_id'] && $data['location_id'] && $data['name'] && $data['logo'] && $data['city'] && $data['short_description'] && $data['status_owner_manager'] && $data['opening_hrs'] && $data['closing_hrs'] && $data['working_days'] && $data['phone']) {
                    ...
                    if ($emailExists == 0) {
                        ...
                        $insertData['address'] = (isset($data['address']) && $data['address']) ? $data['address'] : "";
                        $insertData['short_description'] = (isset($data['short_description']) && $data['short_description']) ? $data['short_description'] : "";
        ...
        try {
            ...
            if ($data) {
                ...
                if ($data['id'] && $data['category_id'] && $data['location_id'] && $data['name'] && $data['logo'] && $data['city'] && $data['short_description'] && $data['status_owner_manager'] && $data['opening_hrs'] && $data['closing_hrs'] && $data['working_days'] && $data['phone']) {
                    ...
                    $input['owner_designation'] = (isset($data['owner_designation']) && $data['owner_designation']) ? $data['owner_designation'] : "";
                ...
                if (isset($data['id']) && $data['id']) {
                    ...
                    if ($serviceProvider) {
                        ...
                        if ($data['working_days'] == 1) {
                            $data['working_days'] = "Mon to Fri";
                        } else if ($data['working_days'] == 2) {
                            $data['working_days'] = "Mon to Sat";
                        } else {
                            $data['working_days'] = "All the Days";
                        }
